...
def Autorisation( login, password):
    LoginArea = Driver.find_element_by_name("identifier")
    #LoginArea = Driver.find_element_by_id("Email")
    LoginArea.send_keys(login)
    Driver.set_page_load_timeout(30)#time.sleep(2)
    
    ButtonNext = Driver.find_element_by_css_selector("button.VfPpkd-LgbsSe")
    ButtonNext.click()
